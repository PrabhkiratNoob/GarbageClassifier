...
async def classify_image(image_url: str | None = None, is_url: bool = True) -> dict:
  ...
  # Load image from URL
  try:
    image_resource = urlopen(image_url) if is_url else image_url
    img_pil = Image.open(image_resource)
  ...
  print("All tensors: " + str(tensor_prediction))
